...
const envSchema = z.object({
  ...
  ATTACHMENT_STORAGE_BACKEND: z.enum(["s3", "mock"]).default("s3"),
  ...
  OBJECT_STORAGE_SECRET_ACCESS_KEY: z.string().trim().optional(),
  OBJECT_STORAGE_PUBLIC_BASE_URL: z.string().trim().optional(),
  OBJECT_STORAGE_KEY_PREFIX: z.string().trim().default("feedback-intake"),
